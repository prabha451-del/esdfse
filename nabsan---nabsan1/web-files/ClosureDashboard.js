...
window.location.href="/ClosureUpdateForm/";
}
function UpdateNPA(){
    window.location.href="/NPAUpdateForm/";
}
/*function OpenXL(){
...
// queryList = location.origin+"/_api/cr6fc_cgaplications?$select=*,cr6fc_cgaplicationid,cr6fc_status,cr6fc_nameoflendinginstitution,cr6fc_name,cr6fc_accountno,cr6fc_typeoffacility,createdon,cr6fc_nameoffpo&$filter=cr6fc_status eq 2 or cr6fc_status eq 1 or cr6fc_status eq 4 or cr6fc_status eq 5 or cr6fc_status eq 9 or cr6fc_status eq 6  or cr6fc_status eq 7  or cr6fc_status eq 16 and cr6fc_nameoflendinginstitution eq '"+nameEliInstitute+"'&$top=5000&$orderby=cr6fc_name asc"; 
 queryList = location.origin+"/_api/cr6fc_updateclosures?$select=*,cr6fc_updateclosureid,cr6fc_status&$top=5000&$orderby=cr6fc_name asc"; 
   var requestHeaders = { "accept": "application/json;odata=verbose" };
             ...
             var vURLEdit1='';
                  for(var i=0;i<Loggs.length; i++)
                    { 
                        ...
                        var SubStatus = Loggs[i]['cr6fc_status@OData.Community.Display.V1.FormattedValue'];
                     var ReqStatus ='';
                     ReqStatus = Loggs[i]['cr6fc_requeststatus@OData.Community.Display.V1.FormattedValue'];
                 ...
                 //['cr6fc_typeoffacility@OData.Community.Display.V1.FormattedValue']
				var checkno="<input type='checkbox' id='fullhide'  class='checkbox' name='delete' value="+Loggs[i].cr6fc_cgaplicationid+">"
                    vHTML += "<tr style='line-height: 16px;'>"+	
							...
							"<td style='text-align:center'>"+Loggs[i].cr6fc_typeoffacility+"</td>"+
							"<td style='text-align:center'>"+ReqStatus+"</td>"
							"<td style='text-align:center'>"+SubStatus+"</td>"+
						   "<td style='text-align:center;margin:0; padding-top: 15px !important;'></td>"+
