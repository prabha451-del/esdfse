...
function Dashboard(nameEliInstitute){
    ...
    var vURLEdit1='';
    var URLView="";
    queryList = location.origin+"/_api/cr6fc_updateclosures?$select=*&$top=5000&$orderby=cr6fc_name asc"; 
    var requestHeaders = {"accept":"application/json;odata=verbose"};
    $.ajax({
        url:queryList,
        type:"GET",
        ...
        success: function onSuccess(data) {
            try
            {
             ...
             var vURLEdit1='';
                  ...
                  if( Status =="Saved"){
                  		vURLEdit1 ="/UpdateClosureELICheckerForm?Item="+Loggs[i].cr6fc_updateclosureid;
				...
				var checkno="<input type='checkbox' id='fullhide'  class='checkbox' name='delete' value="+Loggs[i].cr6fc_cgaplicationid+">"
                    vHTML += "<tr style='line-height: 16px;'>"+	
                           ...
                           "<td style='text-align:center; margin:0; padding-top: 15px !important;'>"+vURLEdit1+"</td>"+
