...
queryList = location.origin+"/_api/cr6fc_cgaplications?$select=cr6fc_cgaplicationid,cr6fc_name,cr6fc_nameoffpo,cr6fc_status,createdon,cr6fc_accountno,cr6fc_sanctionedamount,cr6fc_guaranteestartdate,cr6fc_cgstatus&$filter=cr6fc_nsapproveremail eq '"+loggedInUserEmail+"' and cr6fc_status eq 15 &$top=5000"; 
       ...
       success: function (data)
       {
            ...
            try
            {
                ...
                { 
                        ...
                        "<td style='text-align:center'>"+Loggs[i].cr6fc_cgstatus+"</td>"+
                        "<td style='text-align:center'>"+Loggs[i].cr6fc_status+"</td>"+
                        "<td style='text-align:center;margin:0; padding-top: 15px !important;'>"+vURLRenew+"</td>"+
