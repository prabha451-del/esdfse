...
function Dashboard(){
 ...
 queryList = location.origin+"/_api/cr6fc_cgaplications?$select=cr6fc_cgaplicationid,cr6fc_name,cr6fc_nameoffpo,cr6fc_status,createdon,cr6fc_accountno,cr6fc_sanctionedamount,cr6fc_guaranteestartdate,cr6fc_cgstatus&$filter=cr6fc_nscheckeremail eq '"+loggedInUserEmail+"' and cr6fc_status eq 15 &$top=5000"; 
 var requestHeaders = { "accept": "application/json;odata=verbose" };
 $.ajax({
        url: queryList,
        type: "GET",
        ...
        success: function (data)
        {
            ...
            try
            {
                ...
                for(var i=0;i<Loggs.length; i++)
                { 
                    var vURLView ="https://nabardmumbai.sharepoint.com/sites/FPOCGPortalUAT/SitePages/Renewal Application/RenewalCGApplication.aspx?Item="+Loggs[i].ID;
                    var vURLRenew ="";
                    ...
                    if(Loggs[i].cr6fc_sanctionedamount!=null && Loggs[i].cr6fc_sanctionedamount!='')
                    {
                        ...
                        vHTML += "<tr style='line-height: 16px;'>"+	
                                    ...
                                    "<td style='color:Black; text-align:center'>"+Loggs[i].cr6fc_cgstatus+"</td>"+
                                    "<td style='color:Black; text-align:center'>"+Loggs[i].cr6fc_status+"</td>"+
                                    "<td style='style='color:Black; text-align:center;margin:0; padding-top: 15px !important;'>"+vURLRenew+"</td>"+
                                    "<td style='style='color:Black; text-align:center; display:none;'>"+Loggs[i].cr6fc_cgaplicationid+"</td>"+
                                    "</tr>";														                                       																					
                    }
